...
function TalkTab(props: Props) {
    ...
    return (
        <Box width="full" bg="brand.secondarybg" display={"flex"} flexDirection={"column"} mt="20px" border="1px" rounded="10px" borderColor="#FFFFFF0D" color="white" py="15px" px="22px" >
