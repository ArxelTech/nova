    ...
    return (
        <Box width="full" bg="brand.secondarybg" display={"flex"} flexDirection={"column"} mt="20px" border="1px" rounded="10px" borderColor="#FFFFFF0D" color="white" py="15px" >
            <Flex alignItems={"center"} px={"10px"} borderBottom={"1px"} borderColor={"#FFFFFF0D"} justifyContent={"space-between"} >
                <Flex gap={"8px"} >
                    <Text as={"button"} onClick={()=> setTab(false)} fontFamily={"500"} fontSize={"sm"} pb={"3px"} borderBottom={"1px"} px={"10px"} mb={"-1px"} color={!tab ? "brand.base" : "brand.inactive"} borderColor={!tab ? "brand.base": "#FFFFFF0D"}>Link</Text>
                    <Text as={"button"} onClick={()=> setTab(true)}  fontFamily={"500"} fontSize={"sm"} pb={"3px"} borderBottom={"1px"} px={"10px"} mb={"-1px"}  color={tab ? "brand.base" : "brand.inactive"} borderColor={tab ? "brand.base": "#FFFFFF0D"} >Room ID</Text>
                </Flex>
            </Flex>
            <Box pt={"19px"} px={"22px"}  >
