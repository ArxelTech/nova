        ...
        <Flex width="full" bg={"brand.black"} alignItems="center" justifyContent="space-between" borderBottom={"1px"} h={"130px"} px="32px" >
            ...
            {user && (
                <Flex gap="8px" >
                    ...
                    <Button onClick={()=> navigate("/streaming")} color="white" px="14px" height="42px" fontSize="14px" fontFamily={"600"} border="1px" borderColor="white" rounded="8px" _hover={{ backgroundColor: "transparent"}} _focus={{ backgroundColor: "transparent"}} bg="transparent" >Join A Watch Party</Button>
                </Flex>
            )}
        </Flex>
    )
